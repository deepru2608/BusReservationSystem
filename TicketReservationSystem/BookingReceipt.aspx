<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BookingReceipt.aspx.cs" Inherits="TicketReservationSystem.BookingReceipt" %>
                        ...
                        <td style="padding-bottom: 40px; padding-top: 20px">
                            ...
                            <table class="tableAlign" style="width: 100%; margin-top: 2%">
                                ...
                                <tr>
                                    ...
                                    <td class="rightAlign tableBorder">
                                        <asp:Label ID="lblStatus" runat="server" Text="Booked"></asp:Label></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
